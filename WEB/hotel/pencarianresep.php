...
<li><a href="homeresepsionis.php">Home</a></li>
  ...
  <tr>
    <td height="225" colspan="3" align="center" valign="top" bgcolor="#999999"><h2>DATA RESERVASI
      ...
      <form id="search" name="form1" method="post" action="pencarianresep1.php">
Cari Berdasarkan Nama :
        <label for="search"></label>
        <input name="search" type="text" id="search2" size="40" />
      </form>
      <p>&nbsp;</p>
      <?php if ($totalRows_tampilreservasi > 0) { // Show if recordset not empty ?>
  <table width="100%" border="0" align="center">
    <tr>
      <td align="left">Nomor Pesanan</td>
      <td>ID Tamu</td>
      <td>Nama Tamu</td>
    ...
    <?php do { ?>
      <tr>
        <td height="27" align="center"><?php echo $row_tampilreservasi['nomor_pesanan']; ?></td>
