...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO `admin` (id_admin, nama_admin, username, password, email) VALUES (%s, %s, %s, %s, %s)",
...
<table width="1224" height="355" border="1" align="center">
  ...
  <tr>
    <td height="225" colspan="4" align="center" bgcolor="#CCCCCC"><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <h2>RESGISTRASI ADMIN</h2>
      <table align="center">
        <tr valign="baseline">
          <td align="center" valign="middle" nowrap="nowrap">ID Admin:</td>
          <td><input name="id_admin" type="text" value="" size="32" readonly="readonly" /></td>
        </tr>
        <tr valign="baseline">
          <td align="center" valign="middle" nowrap="nowrap">Nama Admin:</td>
          <td><input type="text" name="nama_admin" value="" size="32" required /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td align="center" valign="middle" nowrap="nowrap">Email:</td>
          <td><input type="text" name="email" value="" size="32" required /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">&nbsp;</td>
          <td align="center"><input type="submit" value="DAFTAR" />
