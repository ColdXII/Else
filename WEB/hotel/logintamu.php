...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "hometamu.php";
  $MM_redirectLoginFailed = "registrasitamu.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_koneksi, $koneksi);
  
  $LoginRS__query=sprintf("SELECT username, password FROM tamu WHERE username=%s AND password=%s",
  ...
  <tr>
    <td height="225" colspan="4" align="center" bgcolor="#CCCCCC"><form name="form2" method="POST" action="<?php echo $loginFormAction; ?>">
        <table width="491" border="0" align="center">
          <tr>
            <td height="43" colspan="2" align="center" bgcolor="#FFFFFF"><h2>LOGIN AS TAMU</h2></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="38" colspan="2" align="center" bgcolor="#CCCCCC"><label for="password">
              <input type="submit" name="button" id="button" value="LOGIN" />
            </label></td>
          </tr>
        </table>
        <p>ATAU <a href="registrasitamu.php">DAFTAR TERLEBIH DAHULU</a></p>
    </form></td>
  </tr>
  <tr>
